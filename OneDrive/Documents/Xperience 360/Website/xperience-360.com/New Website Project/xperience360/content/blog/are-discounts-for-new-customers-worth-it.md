...
Let's make the same assumptions as we did for previous campaigns, so we can compare them.

As with the previous cases, we assume 75% of new customers make only an initial purchase, and the other 25% make at least one more purchase.
...
The initial discount investment often reduces margins when the focus is on new customer acquisition. Many new customers acquired through promotions may not stay for the long term, lowering the overall CLV. However, existing customers may already trust the brand and spend consistently. If neglected, their lifetime value will plummet, making any acquisition gains look minimal by comparison.
...
While **Campaign C (Mixed) generates higher total revenue** due to its larger customer base, and **Campaign A (New Customers) helps to expand the customer base**, Campaign B's focus on existing customers maximises the value generated per customer.
...
In this context of customer acquisition and retention campaigns, offering discounts exclusively to new customers can frustrate existing customers, leading to complaints and negative word-of-mouth. Frustratingly, this can lead to higher operational costs and damage the overall customer experience.
...
Campaign B has the lowest Failure Demand (5%), reflecting existing customers' familiarity with products and processes

Campaign C maintains a moderate level (12.5%), balancing the higher support needs of new customers with the efficiency of serving existing customers.
...
Campaign A's low EGR (5%) reflects the challenges of building advocacy among new customers.
...
Although NES is a critical metric in real-world business operations, we have excluded it from our quantitative analysis of the three campaigns. Including it would require significant additional data on customer experiences and interaction patterns that would be purely speculative in our scenario-based study. Making such assumptions could reduce the realism of our analysis.
...
**Existing customer campaign (B) has the lowest churn rate** (70%), reflecting the stronger loyalty of existing customers even in discount scenarios.

The 5% difference in churn rates between Campaigns A and B represents a minimal difference that would normally be higher in real life. It highlights the value of nurturing existing customer relationships.
...
Campaign B, targeting **existing customers, achieves the highest RPR** at 30%, confirming that loyal customers are more likely to make repeat purchases, even in discount scenarios. As with Campaign A, we assume that the retention rate we have set is a maximum, so in reality, the difference in RPR between Campaigns A and B would be higher.

Campaign C falls in the middle with an RPR of 28.5%, benefiting from the mixed approach that combines the higher repeat purchase propensity of existing customers (30% of 105 customers) with the lower rate of new acquisition (25% of 45 customers).
...
Customer Acquisition Cost (CAC) is a fundamental business metric that measures the total cost of acquiring a new customer. It includes all marketing and sales expenses, including advertising costs, marketing team salaries, tools and software, and promotional costs such as discounts.

While CAC would be highly relevant to the analysis of our three campaign scenarios, calculating it would require making numerous assumptions about marketing budgets, operational costs, and campaign costs, which would be purely speculative given our limited data set. With our sample size of 100-150 customers, any CAC calculations would be based on arbitrary cost assumptions that may not reflect real-world conditions or be scalable to larger customer bases.

However, in actual business implementations of these discount strategies, CAC would be a crucial metric for evaluating campaign effectiveness and determining the true cost of acquiring customers through different promotional approaches.

**Return on Investment (ROI)**

Return on Investment (ROI) is a critical and widely used performance metric that measures the profitability of an investment relative to its cost. For discount campaigns such as those in our study, ROI would typically consider all campaign costs (marketing, operations, discounts) against the revenue generated from both initial and repeat purchases.

However, calculating ROI for our scenarios would require making significant assumptions about investment costs, which we cannot reliably estimate with our limited data set. While we have clear revenue figures from customer purchases, the investment side of the equation would include speculative costs for campaign execution, marketing and operations. Such assumptions could lead to misleading ROI calculations that don't accurately reflect real-world campaign performance.

Nevertheless, in actual business implementations, ROI would be an essential metric for evaluating the financial success of these different discount strategies and determining which approach delivers the best returns.
...
<table class="summary-table">
  <thead>
    <tr>
      <th>KPI</th>
      <th>Campaign A (New)</th>
      <th>Campaign B (Existing)</th>
      <th>Campaign C (Mixed)</th>
      <th>Winner</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td>£7,500</td>
      <td>£8,000</td>
      <td class="winner">£11,775</td>
      <td>C</td>
    </tr>
    <tr>
      <td>Retention Rate</td>
      <td>25%</td>
      <td class="winner">30%</td>
      <td>28.5%</td>
      <td>B</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>Earned Growth Rate</td>
      <td>5%</td>
      <td class="winner">20%</td>
      <td>15%</td>
      <td>B</td>
    </tr>
    <tr>
...
In this exercise, we've shown that focusing on new customer acquisition alone doesn't really pay off in terms of any of the commonly used business metrics. In fact, our scenario shows that it's the opposite: focusing on existing customers brings more business.

Our research also shows that campaigns targeting only existing customers are more effective than a mix of both existing and new customers. This may be hard to believe, and it would probably come with a lot of ifs and buts if we were talking about real life campaigns. In the grand scheme of things, acquiring new customers has been and will continue to be a must in any business strategy, so we should not take this study as an invitation to abandon any new customer strategy, because that would be next to suicidal.

There are many studies, much larger and more academic than this one, that have concluded that retaining customers is far more cost effective and about 70% cheaper than acquiring new ones. For example, a widely cited article in the Harvard Business Review entitled The Economics of E-Loyalty by Frederick F. Reichheld and Phil Schefter, Harvard Business Review, July 2000.
